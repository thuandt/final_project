...
Hạ tầng sản phẩm công nghệ ở đây bao gồm: hạ tầng máy chủ (Linux) cùng các cấu hình; các dịch vụ hệ thống như NTP, SSH, Cron, DHCP, DNS, .v.v.; các dịch vụ và ứng dụng phục vụ trực tiếp cho sản phẩm như webserver (apache, nginx), database (postgresql, mysql) .v.v.
